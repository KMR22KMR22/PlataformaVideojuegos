...
public class GameForm {
    ...
    public GameForm(int id, String tittle, String description, String desarrollador, LocalDate launchDate, float basePrice, float currentDescount, GameCategory category, AgeClasification ageClasification, String[] availabeLanguages, GameState state) {
        this.id = id;
        this.tittle = tittle;
        this.description = description;
